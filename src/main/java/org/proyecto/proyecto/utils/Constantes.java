...
public enum Constantes {
    ...
    TITULO_HILO_NUEVO("Hilo añadido"),
    AVISO_HILO_NUEVO("Hilo añadido a la lista."),
    TITULO_HILO_MODIFICADO("Hilo modificado"),
    AVISO_HILO_MODIFICADO("Hilo modificado correctamente."),
